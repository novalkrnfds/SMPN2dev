...
kemampuan intelektual dan mental</font></div>
	...
	<div class="inner light">
		...
		<div class="one-fourth">
			<img src="<?php echo base_url();?>assets/strukturjs/images/photos/avatarF.png" width="100%" alt="Drs. Moh. Khotim, M.Pd">
		</div>
		<div class="row-item">
				...
				<p style="text-align: justify;">Website SMP Negeri 2 Sungai Penuh dibuat dengan tujuan untuk memberikan informasi secara menyeluruh kepada masyarakat mengenai kegiatan dan prestasi sekolah, sehingga diharapkan dapat menjadi salah satu sarana interaksi langsung masyarakat dengan SMP Negeri 2 Sungai Penuh.</p>
				<p style="text-align: justify;">Semoga masyarakat dan siswa yang berkepentingan agar dapat memanfaatkan website ini dengan sebaik-baiknya. Kami dari pihak sekolah berharap semoga kita memperoleh kemudahan dalam mencapai cita-cita, untuk kemajuan SMP Negeri 2 Sungai Penuh, bangsa dan negara yang tercinta di masa yang akan datang.</p>
